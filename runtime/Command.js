...
export class HostRequest {
    /** @param {string} command - Canonical command name. @param {Object} data - Command payload. */
    ...
    /** @param {*} raw - Untrusted endpoint request. @returns {HostRequest} Validated request. */
    static parse(raw) {
...
export class CommandContext {
    /** @param {import("./Session.js").PeerSession} peer - Requesting peer. @param {HostRequest} request - Validated request. */
    ...
    /** @param {import("./Session.js").RoomSession|null} session - Current room session. @returns {CommandContext} This context. */
    attachSession(session) {
        this.session = session;
        return this;
    }

    /** @param {string} roomKey - Normalized room key. @param {import("../core/Room.js").Room} room - Room model. @returns {CommandContext} This context. */
...
export class CommandRouter {
    /** @param {Object<string, function(CommandContext): Promise<void>>} handlers - Built-in handlers. @param {function(CommandContext): Promise<void>} fallback - Game-command handler. */
    ...
    /** @param {import("./Host.js").Host} receiver - Owning Host. @param {CommandContext} context - Resolved command. @returns {Promise<void>} */
