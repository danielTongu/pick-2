...
export class HostPeer {
    ...
    /** @param {function(*): Promise<void>} request - Request dispatcher. @param {function(): Promise<void>} close - Close callback. */
    ...
    /** @param {*} message - Untrusted command request. @returns {Promise<void>} */
    receive(message) {
...
export class PeerSession {
    ...
    /** @param {number} code - Transport close code. @param {string} reason - Close reason. */
...
export class SessionRegistry {
    ...
    /** @param {import("./Transport.js").PeerChannel} channel - Transport boundary. @returns {PeerSession} New peer. */
    createPeer(channel) {
    ...
    /** @param {string} tabId - Browser-tab identity. @returns {boolean} Whether registered. */
    has(tabId) {
        return this.#roomSessions.has(tabId);
    }

    /** @param {string} tabId - Browser-tab identity. @returns {RoomSession|null} Current room session. */
    get(tabId) {
        return this.#roomSessions.get(tabId) ?? null;
    }

    /** @param {string} tabId - Browser-tab identity. @param {PeerSession} peer - Connected peer. @param {string} roomKey - Normalized room key. @param {string|null} playerName - Seated player or null. @returns {RoomSession} */
    ...
    /** @param {string} tabId - Browser-tab identity. @param {PeerSession} peer - Connected peer. @returns {RoomSession|null} */
    ...
    /** @param {string} roomKey - Normalized room key. @returns {RoomSession[]} Stable session snapshot. */
    inRoom(roomKey) {
        const sessions = [];
    ...
    /** @param {string} roomKey - Normalized room key. @param {string} playerName - Player name. @returns {RoomSession|null} */
    ...
    /** @param {PeerSession} peer - Connected peer. @returns {RoomSession|null} */
    findPeer(peer) {
    ...
    /** @param {RoomSession} session - Captured session. @returns {boolean} Whether it remains registered. */
    isCurrent(session) {
