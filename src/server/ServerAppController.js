...
export class ServerAppController {
    ...
    /** @type {import("./ServerRoomController.js").ServerRoomController} */
    #roomController;
     ...
     * @param {import("./ServerRoomController.js").ServerRoomController} roomController - Room controller.
     */
     ...
     */
    async start() {
        ServerAppController.#renderCopyrightYear();
        ...
        ServerAppController.#synchronizeCardSortOptions();
        ServerAppController.#synchronizeGameGuideCardScores();
        ServerAppController.#renderGameGuideSpecialCards();
        this.#showLobby();
